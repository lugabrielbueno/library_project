	...
	<li class="mb-1">
		...
		<div class="collapse" id="dashboard-collapse">
			<ul class="btn-toggle-nav list-unstyled  small">
				<li><a href="/readers/create" style='width:100%;text-align:left;' class="link-dark  btn btn-light  "><i class='fa fa-circle'></i> Register new reader</a></li>
				<li><a href="/readers" style='width:100%;text-align:left;' class="link-dark  btn btn-light "><i class='fa fa-circle'></i> Search reader</a></li>
			</ul>
		</div>
	</li>
